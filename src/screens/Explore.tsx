...
import { useGetAudioCategoriesQuery, useGetVideoCategoriesQuery } from '@/api/categoriesApi';
                ...
                {filteredCategories.map((section: AudioCategory) => (
                    <View key={section.id} style={styles.section}>
                        <TouchableOpacity onPress={() => {
                            ...
                            navigate(SCREEN_NAMES.AudioSubcattegories, { section: section, type: 'Video' });
                        }} style={styles.row2}>
