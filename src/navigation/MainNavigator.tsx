...
const MainTabs: React.FC = () => {
    return (
        ...
        >
            ...
            <Tab.Screen name="Explore" component={SettingsScreen} options={{ tabBarLabel: 'Explore' }} />
            <Tab.Screen name="Video" component={Explore} options={{ tabBarLabel: 'Video' }} />
            <Tab.Screen name="Audio" component={AudioCategoryScreen} options={{ tabBarLabel: 'Audio' }} />
        </Tab.Navigator>
    );
};
